...
COMMON_LENGTH_DICT = {
    ...
    3: ['act', 'add', 'age', 'ago', 'air', 'all', 'and', 'any', 'arm', 'art', 'ask', 'bad', 'bag', 'bar', 'bed', 'big', 'bit', 'box', 'boy', 'but', 'buy', 'can', 'car', 'cup', 'cut', 'day', 'die', 'dog', 'eat', 'end', 'eye', 'far', 'few', 'fly', 'for', 'gas', 'get', 'gun', 'guy', 'her', 'him', 'his', 'hit', 'hot', 'how', 'its', 'job', 'key', 'kid', 'law', 'lay', 'leg', 'let', 'lie', 'lot', 'low', 'man', 'may', 'mrs', 'new', 'nor', 'not', 'now', 'off', 'oil', 'old', 'one', 'our', 'out', 'own', 'pay', 'per', 'put', 'red', 'run', 'say', 'sea', 'see', 'set', 'she', 'sit', 'six', 'son', 'tax', 'ten', 'the', 'too', 'top', 'try', 'two', 'use', 'war', 'way', 'who', 'why', 'win', 'yes', 'yet', 'you'], 
